...
class CustomView extends events_1.EventEmitter {
    ...
    init() {
        ...
        let options = {
            ...
            localResourceRoots: [vscode_1.Uri.parse(this.resourcesPath).with({ scheme: 'vscode-resource' })]
        };
    ...
    replaceUris(html, htmlPath) {
        let basePath = vscode_1.Uri.parse(path_1.dirname(htmlPath)).with({ scheme: this.resourceScheme }).toString();
