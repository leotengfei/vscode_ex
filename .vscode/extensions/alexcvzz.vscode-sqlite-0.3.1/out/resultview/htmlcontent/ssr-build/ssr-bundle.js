...
var statement_Statement = /** @class */ (function (_super) {
    ...
    Statement.prototype.render = function (props, state) {
        return (Object(preact_min["h"])(fetch_Fetch, { resource: "resultSet/" + props.idx + "/stmt" }, function (response) { return (Object(preact_min["h"])("div", null,
            response.loading && Object(preact_min["h"])("code", null, "Loading..."),
            response.error && Object(preact_min["h"])("code", null,
                "Error: ",
                response.error),
            response.data && Object(preact_min["h"])("code", null, response.data))); }));
    };
    return Statement;
}(preact_min["Component"]));
...
var trow_TRow = /** @class */ (function (_super) {
        ...
        if (nextProps.row && nextProps.n != null) {
            ...
            for (var i = 0; i < nextProps.row.length + 1; i++) {
                ...
                if (i === 0)
                    ...
                    td.innerHTML = nextProps.row[i - 1];
            }
        }
        else {
    ...
    TRow.prototype.render = function (props, state) {
        return (Object(preact_min["h"])("tr", null));
    };
    return TRow;
}(preact_min["Component"]));
...
var style = __webpack_require__("ukti");
...
var table_Table = /** @class */ (function (_super) {
    ...
    Table.prototype.render = function (props, state) {
        return (Object(preact_min["h"])("table", { class: style_default.a.table },
        ...
        return (Object(preact_min["h"])("div", null,
            Object(preact_min["h"])(fetch_Fetch, { resource: "resultSet/length" }, function (response) {
                return Object(preact_min["h"])("div", null,
                    ...
                    response.data && range(0, response.data - 1).map(function (idx) { return Object(preact_min["h"])(result_Result, { idx: idx }); }));
            })));
    };
    return App;
}(preact_min["Component"]));
